...
///https://github.com/JetStream96/MinMaxHeap/blob/master/src/MinMaxHeap/MinHeap.cs
public class MinHeap<T> : IEnumerable<T>
{
	...
	public int Count { get { return values.Count - 1; } }

	public T Min { get { return values[1]; } }
	...
	public IEnumerator<T> GetEnumerator() { return values.Skip(1).GetEnumerator(); }
